...
module.exports.execute = async (client, message, args) => {
  ...
  if(!user) return message.channel.send(embed.setDescription(`Bir Kullanıcı Etiketleyiniz. \`${config.prefix}yetkibaslat @Diego/ID\` `)).catch(e => { })
...
exports.conf = {
    command: "yetkiver", // Asıl komutumuz
